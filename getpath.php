...
//header('Content-Type: application/json');
	if(isset($_GET["plate_number"])){
		...
		$sql = "SELECT *,extract(epoch from tracking_date) AS tracktime FROM vehicle v,vehicle_tracker vt WHERE plate_number='".$_GET["plate_number"]."' AND v.id = vt.vehicle_id";
